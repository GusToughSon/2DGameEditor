...
class ChunkEditor:
    ...
    def _setup_shortcuts(self):
        ...
        # Tool Shortcuts
        self.win.bind("p", lambda e: self.set_tool("PENCIL"))
        self.win.bind("s", lambda e: self.set_tool("SELECT"))
        self.win.bind("v", lambda e: self.set_tool("PASTE"))
        self.win.bind("f", lambda e: self.set_tool("FILL"))
        
        # Navigation Shortcuts
        self.win.bind("<Left>", lambda e: self._prev_chunk())
        self.win.bind("<Right>", lambda e: self._next_chunk())
        
        # Undo/Redo Shortcuts
        self.win.bind("u", lambda e: self.handle_undo())
        self.win.bind("r", lambda e: self.handle_redo())
        self.win.bind("t", lambda e: self.handle_rotate())
