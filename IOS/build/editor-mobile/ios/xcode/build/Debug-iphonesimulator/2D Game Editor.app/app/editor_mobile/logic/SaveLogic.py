...
// --- 4. MAPS ---
DEFINE GLOBAL MAP_DRANSIK             0
DEFINE GLOBAL MAP_OVERWORLD           1
...
"""
    ...
    def save_chunks(self, chunks, chunk_ids_to_save=None):
        """ 
        Saves all chunks to the Chunks.json Registry.
        The chunk_ids_to_save argument is kept for API compatibility but the whole 
        registry is saved regardless.
        """
