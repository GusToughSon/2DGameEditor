...
find "$CODESIGNING_FOLDER_PATH/python/lib/python3.9/lib-dynload" -name "*.so" -not -path "*/*.so.dSYM/*" | while read FULL_EXT; do
    install_dylib python/lib/python3.9/lib-dynload/ "$FULL_EXT"
done
